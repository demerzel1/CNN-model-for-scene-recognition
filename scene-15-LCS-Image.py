...
if __name__ == '__main__':
    ...
    dict_trained = model_zoo.load_url(model_urls['alexnet'])
    ...
    # save best model
    torch.save(model_ft,"output/15-best_alex_lcs_preall.pkl")
    torch.save(model_ft.state_dict(), 'output/15-best_alex_lcs_params_preall.pkl')  
