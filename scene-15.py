...
if __name__ == '__main__':
    ...
    # save best model
    torch.save(model_ft,"output/15-best_alex1_nopre.pkl")
...
class_names_map = {0:'bedroom', 1:'suburb', 2:'industrial', 3:'kitchen', 4:'livingroom', 5:'coast', 6:'forest', 7:'highway', 8:'insidecity', 9:'mountain', 10:'opencountry', 11:'street', 12:'tallbuilding', 13:'office', 14:'store'}

class_names = ['bedroom', 'suburb', 'industrial', 'kitchen', 'livingroom', 'coast', 'forest', 'highway', 'insidecity', 'mountain', 'opencountry', 'street', 'tallbuilding', 'office', 'store']
